...
public class MainActivity extends Activity {
    ...
    private class ServerCheckTask extends AsyncTask<Void, Void, Boolean> {
        @Override
        ...
        protected void onPostExecute(Boolean connected) {
            if (connected) {
                ...
                loadErrorPage();
                Toast.makeText(MainActivity.this, "Cannot reach Celsius AI server", Toast.LENGTH_LONG).show();
            }
        }
    }
